  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between pb-5 border-b border-[rgba(255,255,255,0.06)] mb-5">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white to-[#A0A0A8] flex items-center justify-center shadow-lg shadow-[rgba(255,255,255,0.08)]">
                {isTerms ? <FileText className="w-5 h-5 text-white" /> : <ShieldCheck className="w-5 h-5 text-white" />}
              </div>
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-xl text-[#888888] hover:text-white hover:bg-[rgba(255,255,255,0.05)] transition-all"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {/* Content */}
          <div className="space-y-4 text-sm max-h-[60vh] overflow-y-auto pr-2 text-[#AAAAAA] leading-relaxed">
            {isTerms ? (
              <>
                <p>
                ...
                <h4 className="font-semibold text-white text-base pt-3">1. Account Security</h4>
                <p>
                ...
                <h4 className="font-semibold text-white text-base pt-3">2. Usage Rights</h4>
                <p>
                ...
                <h4 className="font-semibold text-white text-base pt-3">3. Termination</h4>
                <p>
              ...
              <>
                ...
                <h4 className="font-semibold text-white text-base pt-3">1. Information Collection</h4>
                <p>
                ...
                <h4 className="font-semibold text-white text-base pt-3">2. Data Security</h4>
                <p>
                ...
                <h4 className="font-semibold text-white text-base pt-3">3. Third-Party Services</h4>
                <p>
          ...
          {/* Footer */}
          <div className="mt-6 pt-5 border-t border-[rgba(255,255,255,0.06)] flex justify-end">
            <button
              onClick={onClose}
